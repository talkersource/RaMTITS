/* ident.h                                                                   *
 ...
 -  Neil Peter Charley.							     -
 -  Portions of the code (notably that for Solaris 2.x and BSD compatability)-
 -  are Copyright 1996 James William Hawtin. Thanks also goes to James for   -
 -  pointing out ways to make the code more robust.			     -
 -  ALL code contained herein is covered by one or the other of the above    -
 -  Copyright's.                                                             -

 -  Permission to use this code authored by the above person(s) is given     -
 -  provided:                                                                -
 ...
 -      to yourself)                                                         -
 -      NB: Special permission has been given to the maintainer of the       -
 -	    package known as 'SensiSummink' AND to the maintainer of the     -
 -          package known as 'PG+' (later version of PG96) AND to the	     -
 -          maintainers of the package known as 'RaMTITS' to make use of     -
 -	    this code in that. Anyone using this package automatically gets  -
 -	    the right to USE this code.					     -
 -	    You are *NOT*, however, given permission to redistribute it in   -
 -	    other forms other than passing on the package that you yourself  -
 -	    received.				     			     -
 ...
 -           so please try and send them to him first. The current best      -
 -           email address for contacting him is:                            -
...
/* *IF* you get compile errors about not having 'FIONBIO' comment out the -
 - next line [you may start getting other problems though]		  */
#define NONBLOCKING
